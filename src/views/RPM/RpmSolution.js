        ...
        <div className="rpm-container2">
          <div>
            <p className="rpm-section2-maintext">
              What is{" "}
              <span style={{ fontSize: "40px", color: "#F68C29" }}>R</span>emote{" "}
              <span style={{ fontSize: "40px", color: "#F68C29" }}>P</span>
              atient{" "}
              <span style={{ fontSize: "40px", color: "#F68C29" }}>M</span>
              onitoring?
            </p>
            <span className="rpm-section2-subtext">
              Remote patient monitoring (RPM) allows doctors to monitor,
              <br /> report, and analyze a patient's acute or chronic conditions
              <br /> while the patient is away from the hospital or clinic.
              <br /> Conveniently allows doctors to review personal health and
              <br /> medical data from a location separate from the patient,
              from anywhere.
              <br /> Herings uses RPM-based services to enable doctors and
              <br /> patients to overcome distance barriers and provide
              <br /> therapeutic action in a short period of time in any
              location.
            </span>
          </div>
        ...
        <div className="rpm-container3">
          <div className="rpm-section3-group-container ">
            {boxItems.map((item) => (
              <div className="rpm-section3-group-box ">
                <img src={item.imgUrl} alt="boximg" />
          ...
          <div className="rpm-section3-text-layout">
            <p className="rpm-section3-maintext">
              Why We Need{" "}
              <span style={{ fontSize: "45px", color: "#F68C29" }}>RPM</span>
              <span style={{ fontSize: "45px" }}>?</span>
            </p>
            <span className="rpm-section3-subtext">
              Remote patient monitoring allows medical staff to manage
              <br /> large numbers of patients without distance constraints and
              <br /> improves the efficiency of patient care. Patients can
              directly <br /> record and manage their health status and receive
              feedback
              <br /> from medical staff based on the recorded data.
              <br /> Other benefits include the increase in the elderly
              population,
              <br /> the need to expand access to healthcare, cost advantages,
              <br /> and savings in healthcare resources.
            </span>
          </div>
        </div>
        <div className="rpm-section4-layout-bg">
                ...
                {serviceItems.map((item) => (
                  <div className="rpm-service-container">
                    ...
                    <div className="rpm-service-text-layout ">
                      ...
                      <span className="rpm-section4-subtext">
                        {item.content}
                      </span>
                      {item.btnText ? (
          ...
          <div className="rpm-container5">
            <div className="rpm-section5-text-layout">
              <p className="rpm-section4-maintext">HERINGS RPM Research!</p>
