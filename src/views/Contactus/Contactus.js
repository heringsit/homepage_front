...
export default function ContactUs() {
    ...
    fetch("/api/contactus", {
      ...
      .then((result) => {
        ...
        if (resGetter) {
          ...
          alert("통신 중 에러가 발생했습니다. 다시 한번 시도해주세요.");
        }
      });
  };
  ...
  return (
    ...
    >
      ...
      <div id="contactus" className="w-screen flex-col justify-between">
        <div className="pb-200">
          <ContentsTitle title={"CONTACT US"} />
          ...
          <div className="SectionDiv" id="contact">
            ...
            <div className="subTitleDiv">
              <div className="contactusSubTitle textT22 FontR">
                <span className="tcgreen1 textT22 FontEB">
                  We are here to help.
                </span>{" "}
                Want to learn more about our services?
                <br />
                Please get in touch,{" "}
                <span className="tco textT22 FontEB">
