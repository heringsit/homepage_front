                  ...
                  {listData.map((data, index) => {
                    return (
                      <div key={index} className="careerListRow FontNR">
                        ...
                        <div
                          className={`newsContainListCol ${fontColor} FontNB ncol8 textF16`}
                        >
                          <div
                            style={{
                              border: "solid 2px",
                          ...
                          <div>
                            <div className="readContentsRow ">
                              ...
                              <div
                                ...
                                style={{ color: "#666666" }}
                              >
                                {moment(modalObj.reg_datetime).format(
                                  "YYYY-MM-DD"
                                )}
                              </div>
                            </div>
